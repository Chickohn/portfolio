...
function getGroupedProjects(allProjects: ProjectItem[]): ProjectCategory[] {
...
export default function ProjectsPageClient({ allProjects }: { allProjects: ProjectItem[] }) {
    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
          <motion.h1 className="text-5xl font-bold text-white text-center mb-4" variants={scrollAnimationVariants}>
            My Projects
          </motion.h1>
          <motion.p className="text-gray-300 text-center mb-12 max-w-2xl mx-auto" variants={scrollAnimationVariants}>
        ...
        >
          ...
          {getGroupedProjects(allProjects).map((category: ProjectCategory) => (
            <motion.div key={category.category} className="space-y-6" variants={scrollAnimationVariants}>
              ...
              <motion.p className="text-gray-300 mb-6" variants={scrollAnimationVariants}>
                    ...
                    <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20 transition-all duration-300 hover-lift">
                      <CardHeader>
                        <div className="flex justify-between items-start">
                          ...
                          <motion.div whileHover={{ scale: 1.2, rotate: 45 }} whileTap={{ scale: 0.9 }}>
